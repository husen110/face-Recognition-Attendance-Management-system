...
class Student:
 ...
 # first image
        ...
        # second image
        img1=Image.open(r"C:\Users\hussein\OneDrive\Desktop\face_recognition_system\college_images\std3.jpg")
        ...
        # third image
        img2=Image.open(r"C:\Users\hussein\OneDrive\Desktop\face_recognition_system\college_images\std2.jpg")
        ...
        Left_frame.place(x=10,y=10,width=720,height=580)
            ...
            # first image
        img_left=Image.open(r"C:\Users\hussein\OneDrive\Desktop\face_recognition_system\college_images\std_img.jpg")
        img_left=img_left.resize((720,130),Image.Resampling.LANCZOS)
        self.photoimg_left=ImageTk.PhotoImage(img_left)

        f_lbl=Label(Left_frame,image=self.photoimg_left)
        f_lbl.place(x=7,y=0,width=710,height=130)
        
        #CURRENT COURSE
        current_course_frame=LabelFrame(Left_frame,bd=2,bg="white",relief=RIDGE,text="Current Course",font=("times new roman",15,"bold"))
        current_course_frame.place(x=5,y=135,width=700,height=120)
        ...
        #year
        year_label=Label(current_course_frame,text="Year",textvariable=self.var_year,font=("times new roman",12,"bold"),bg="white")
        ...
        #semester
        sem_label=Label(current_course_frame,text="Semester",textvariable=self.var_semester,font=("times new roman",12,"bold"),bg="white")
        ...
        class_student_frame.place(x=5,y=245,width=700,height=350)
        ...
        div_combo=ttk.Combobox(class_student_frame,font=("times new roman",12,"bold"),state="readonly",width=18)
        ...
        gender_combo=ttk.Combobox(class_student_frame,textvariable=self.var_year,font=("times new roman",12,"bold"),state="readonly",width=18)
        ...
        img_right=Image.open(r"C:\Users\hussein\OneDrive\Desktop\face_recognition_system\college_images\std2.jpg")
    ...
    def generate_dataset(self):
     if self.var_dep.get() == "Select Department" or self.var_std_name.get() == "" or self.var_std_id.get() == "":
         ...
         try:
            ...
            # lod predifined data on face frontals from opencv
            haar_path = cv2.data.haarcascades + "haarcascade_frontalface_default.xml"
            face_classifier = cv2.CascadeClassifier(haar_path)

            if face_classifier.empty():
                      messagebox.showerror("Error", f"Unable to load Haarcascade from: {haar_path}")
                      return
