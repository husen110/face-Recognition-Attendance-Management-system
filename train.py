...
class Train:
    def __init__(self,root):
        ...
        f_lbl.place(x=0,y=55,width=1530,height=325)
         ...
         #button
        b1_1=Button(self.root,text="Train Data",command=self.train_classifier,cursor="hand2",font=("times new roman",18,"bold"),bg="blue",fg="white")
...
#lbph algo 
    ...
    def train_classifier(self):
        ...
        for image in path:
            ...
            id_str = filename.split('.')[1]  # Example: user.1.1.jpg -> "1"
            id = int(id_str)
